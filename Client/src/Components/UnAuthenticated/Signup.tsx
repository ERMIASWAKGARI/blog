        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          ...
          <form onSubmit={SignUpSubmitHandler} className="space-y-4">
            ...
            >
              <button
                type="submit"
                className="w-full py-3 px-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-indigo-600 hover:to-purple-600 hover:scale-105 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-300"
              >
                Create Account
              </button>
            </motion.div>
